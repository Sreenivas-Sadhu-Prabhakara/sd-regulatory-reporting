package com.bank.bian.regulatoryreporting.model;
...
/**
 * The BIAN control record for this service domain: "Regulatory Report Procedure".
 *
 ...
 * to its asset type (Regulatory Report). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Regulatory Report Procedure";
